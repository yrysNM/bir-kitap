            ...
            <Modal popup animationType="slide-up" visible={showAddClubModal.isOpen} onClose={() => onCloseModal(false)} style={styles.modalWrapper} maskClosable>
                <View>
                    ...
                    <InputStyle inputTitle="Title">
                        <InputItem cursorColor="#212121" selectionColor="#212121" last type="text" style={styles.input} value={clubInfo.title} onChange={(e) => setClubInfo({ ...clubInfo, title: e })} />
                    </InputStyle>
                    ...
                    {showAddClubModal.id !== "add" && (
                        <InputStyle inputTitle="Invite code">
                            <InputItem cursorColor="#212121" selectionColor="#212121" last type="text" style={styles.input} value={inviteCodeValue()} disabled />
